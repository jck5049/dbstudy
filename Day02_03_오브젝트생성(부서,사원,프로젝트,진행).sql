...
CREATE TABLE EMPLOYEE_TBL (
    ...
    CONSTRAINT FK_DEPT_NO FOREIGN KEY(DEPT_NO) REFERENCES DEPARTMENT_TBL(DEPT_NO)  
 );   
...
CREATE TABLE PROCEEDING_TBL (
    ...
    CONSTRAINT FK_EMP_NO FOREIGN KEY(EMP_NO) REFERENCES EMPLOYEE_TBL(EMP_NO),
    CONSTRAINT FK_PJT_NO FOREIGN KEY(PJT_NO) REFERENCES PROJECT_TBL(PJT_NO)
);