...
SET SERVEROUTPUT ON;    --  메세지 업데이트 하려면 이 코드를 한번 작동해야 한다.(결국 출력하려면 1번 작동 ㄱㄱ)
...
CREATE OR REPLACE TRIGGER TRIG1
    ...
    UPDATE
    ON EMPLOYEES
    FOR EACH ROW    -- 행 단위로 트리거가 동작한다는 뜻
BEGIN
...
/*
    ...
    작업 순서
    1. 사원 테이블의 구조를 복사하여 퇴사자 테이블을 생성한다.
