--O 1. EMPLOYEES 테이블에서 JOB_ID를 조회하시오. 동일한 JOB_ID는 한 번만 출력하고 알파벳 순으로 정렬하여 조회하시오.
...
--O 6. EMPLOYEES 테이블에서 HIRE_DATE가 2005년도인 사원을 조회하시오.
...
SELECT FIRST_NAME, LAST_NAME, SALARY, COMMISSION_PCT * SALARY AS 돈
  FROM EMPLOYEES
...
SELECT DISTINCT MANAGER_ID, FIRST_NAME, LAST_NAME, JOB_ID
  FROM EMPLOYEES
